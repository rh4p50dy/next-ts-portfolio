    ...
    <div className='container flex lg:flex-row flex-col items-center'>
        <div className='flex-grow lg:w-2/3'>
            <div className="flex flex-col">
                ...
                <div className="lg:text-[60px] text-[35px] font-[600] text-accent lg:mt-[2%] lg:leading-[60px] mt-[5%] leading-[35px]">Minn Sitt <span className="hidden lg:inline">Paing Mhuu</span> </div>
